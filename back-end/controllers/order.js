const { orderModel, offerModel } = require("../models");
...
const orderController = {
    createOrder: async (req, res) => {
        try {
            ...
            // if(new Date(order.deadline) < new Date(offer.deadline)) de intrebat
            await offer.update({
                isAccepted: true,
            });
    ...
    updateOrder: async (req, res) => {
        try {
            ...
            // if(new Date(newOrder.deadline).getTime() < new Date(offer.deadline).getTime()) de intrebat
